...
#define end_clk double en=clock(); #define show_time cout<<"\tTIME="<<(en-st)/CLOCKS_PER_SEC<<endl;
#define sc(n) scanf("%d",&n)
const ll mod=(ll)1e9+9;
const ll maxi=(ll)1e18+123;
//For Debugging void __print(int x) {cerr << x;}
...
//Integer to char (char+'0') void solve(){
void solve(){
    int n;cin>>n;
    int sum=0;
    map<string,int>mp;
